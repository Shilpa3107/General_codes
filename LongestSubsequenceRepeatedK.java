...
class LongestSubsequenceRepeatedK {
    public static void main(String args[]){
        String s = "leetscode";
        int k = 2;
        LongestSubsequenceRepeatedK obj = new LongestSubsequenceRepeatedK();
        System.out.println(obj.longestSubsequenceRepeatedK(s,k));
    }
